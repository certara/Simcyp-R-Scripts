...
After downloading all the files, open `Power calculation-DDI.R` and run the script.

A detailed video Simcyp™ power calculation tool can be found on [YouTube]( https://www.youtube.com/watch?v=ALCtd9Mw5Ew). 
